...
- Per Sequence GC content: before trimming the GC distribution showed a smooth, bell shaped curve and the peak was obtained at around 45-50% GC, which is consistent for a mammalian GC. After trimming, the distribution remained almost the same and since GC bias was not present, trimming was not aggressively done.
